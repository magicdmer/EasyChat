...
## 提交 Pull Request
1. Fork [此仓库](https://github.com/magicdmer/EasyChat)，从 `main` 创建分支并提交 pull request。
2. 使用 `npm install pnpm@9.15.9 -g` 安装项目固定版本的 `pnpm` 工具。
3. `vscode` 安装了 `Eslint` 插件，其它编辑器如 `webStorm` 打开了 `eslint` 功能。
4. 根目录下执行 `pnpm install --frozen-lockfile`。
