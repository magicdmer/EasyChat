...
1. Fork [this repository](https://github.com/magicdmer/EasyChat), create a branch from `main`, and submit a pull request.
...
4. Execute `pnpm install --frozen-lockfile` in the root directory.
