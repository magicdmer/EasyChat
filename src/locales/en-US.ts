export default {
  ...
  chat: {
    ...
    turnOnDraw: 'Draw mode enabled; the currently selected model will generate the image',
    turnOffDraw: 'Draw mode disabled',
    imagePreview: 'Image preview',
    openImagePreview: 'Open full-size image preview',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
  ...
  setting: {
    setting: 'Setting',
    about: 'About',
    aboutTagline: 'A self-hosted, multi-model AI chat assistant',
    aboutDescription: 'Connect to multiple model providers through OpenAI-compatible APIs, with conversations, multimodal chat, plugin tools, and usage statistics.',
    aboutGithub: 'GitHub Project',
    aboutIssues: 'Report an Issue',
    aboutIssueHint: 'Questions and suggestions are welcome through GitHub Issues.',
