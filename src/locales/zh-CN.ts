export default {
  ...
  chat: {
    ...
    turnOnDraw: '已开启绘图模式，将使用当前选择的模型生成图片',
    turnOffDraw: '已关闭绘图模式',
    imagePreview: '图片预览',
    openImagePreview: '打开图片原图预览',
    zoomIn: '放大',
    zoomOut: '缩小',
    fitScreen: '适应窗口',
    actualSize: '原始大小',
  ...
  setting: {
    setting: '设置',
    about: '关于',
    aboutTagline: '自托管的多模型 AI 对话助手',
    aboutDescription: '通过 OpenAI 兼容接口连接多种模型服务，提供会话管理、图文对话、插件工具与使用统计。',
    aboutGithub: 'GitHub 项目',
    aboutIssues: '问题反馈',
    aboutIssueHint: '欢迎通过 GitHub Issues 提交问题与建议。',
    aboutLicense: '基于 MIT License 开源',
    version: '版本',
    addUser: '添加用户',
    addKey: '添加key',
    key: '密钥',
    ...
    statisticsRequestsNote: '选定时间段内完成的响应',
    statisticsTotalTokens: 'Token 总量',
    statisticsInputShort: '输入',
    statisticsOutputShort: '输出',
    statisticsAverage: '平均每次',
    statisticsAverageNote: '每次请求平均 Token',
    statisticsEstimated: '估算占比',
    statisticsEstimatedNote: '条响应使用估算数据',
    statisticsTokenFlow: '每日 Token 流向',
    statisticsTokenFlowDescription: '输入与输出 Token 按天堆叠，便于发现用量波动。',
    statisticsUserRanking: '用户用量排行',
    statisticsUserRankingDescription: '按 Token 消耗从高到低排列。',
    statisticsModels: '模型分布',
    statisticsModelsDescription: '不同会话模型产生的 Token 用量。',
    statisticsRequestsUnit: '次请求',
    statisticsEmpty: '这个时间段还没有用量数据',
    statisticsLoadFailed: '统计数据读取失败',
    smtpHost: 'Host',
    smtpPort: 'Port',
    smtpTls: 'TLS',
    smtpUserName: '账号',
